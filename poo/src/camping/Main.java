 	...
 	public static void crearemple() {
		...
		do {
			...
			if(!usuario.equalsIgnoreCase("user")|| ! pass.equalsIgnoreCase("1234")) {
				JOptionPane.showMessageDialog(null, "La contrase̱a o el usuario es incorrecto","La Rana",JOptionPane.PLAIN_MESSAGE,new ImageIcon(Main.class.getResource("camping.png")));
			}
